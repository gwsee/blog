...
var file_app_account_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x10, 0x61, 0x70, 0x70, 0x2e, 0x61, 0x63, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x1a, 0x14, 0x61, 0x70, 0x69, 0x2f, 0x67, 0x6c,
...
var file_app_account_internal_conf_conf_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_app_account_internal_conf_conf_proto_goTypes = []any{
	(*Bootstrap)(nil),     // 0: app.account.conf.Bootstrap
...
var file_app_account_internal_conf_conf_proto_depIdxs = []int32{
	1, // 0: app.account.conf.Bootstrap.server:type_name -> api.global.Server
	2, // 1: app.account.conf.Bootstrap.data:type_name -> api.global.Data
	3, // 2: app.account.conf.Bootstrap.auth:type_name -> api.global.Auth
	4, // 3: app.account.conf.Bootstrap.trace:type_name -> api.global.Trace
	5, // 4: app.account.conf.Bootstrap.etcd:type_name -> api.global.Etcd
