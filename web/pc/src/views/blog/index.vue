<template>
  <a-row style="width: 100%"  >
    ...
    <a-col :md="14" :sm="24" :xs="24" class=" rounded-xl p-4 sm:p-6 mb-12"  style="text-align: center;position: relative;    background: linear-gradient(rgb(241 241 241), rgb(173 215 197));" >
      ...
      <a-card :title="item.title" class="blog-card" :hoverable="true" :bodyStyle="{padding:0}" v-for="(item,key) in data">
        ...
        <div style="height: 130px;display: flex">
          <a-avatar :size="100"  style="margin: 15px;" :src="(item.cover&&($fileFull(item.cover)))||defaultCover">
          </a-avatar>
