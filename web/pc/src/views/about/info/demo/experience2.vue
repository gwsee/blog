<template>
  <div class="min-h-screen" ref="backgroundElement">
    <!-- Hero Section -->
    <div :style="{ backgroundImage: `url(${$fileFull(experience.image)||defaultCover})`,backgroundSize:`cover` }">
      <div class="relative h-[30vh] sm:h-[30vh] overflow-hidden max-w-6xl mx-auto px-4 sm:px-8 py-8 sm:py-16">
        ...
        <div class="absolute top-4 left-4 sm:top-8 sm:left-8 z-10">
          <button
              @click="$router.back()"
              class="flex items-center gap-2 text-shadow-lg hover:text-white transition-colors text-white"
          >
          ...
          <div class="max-w-6xl mx-auto">
            <div class="flex flex-col items-start sm:items-end sm:flex-row justify-between gap-4 sm:gap-6">
              <div>
                ...
                <span class="text-xs sm:text-sm text-shadow-lg text-white">{{ $formatDate(experience.start,'{y}-{m}-{d}') }} - {{ $formatDate(experience.end,'{y}-{m}-{d}') }}</span>
              </div>
              <div class="flex gap-2 sm:gap-4 mt-4 sm:mt-0">
                <a
                    ...
                    target="_blank"
                    class="px-4 sm:px-6 py-2 text-sm sm:text-base rounded-full transition-colors"
                    :class="isDarkBackground ? 'bg-white/10 text-white hover:bg-white/20' : 'bg-black/10 text-gray-800 hover:bg-black/20'"
                >
                  Visit Website
                </a>
                <button
      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-8 py-8 sm:py-16">
        <div class="grid md:grid-cols-3 gap-8 md:gap-16">
          ...
          <div class="md:col-span-2 space-y-8 sm:space-y-12">
            <!-- Overview -->
            <div
                class="rounded-xl p-4 sm:p-6 shadow-lg transition-colors duration-300"
            ...
            >
              ...
              >Description</h3>
              <div class="prose" :class="isDarkBackground ? 'prose-invert' : ''">
                <p
              ...
              <div class="prose" :class="isDarkBackground ? 'prose-invert' : ''">
                <p
                    class="text-sm sm:text-base leading-relaxed"
                    :class="isDarkBackground ? 'text-gray-200' : 'text-gray-700'"
                    v-html="formattedContent(experience.responsibilities)"
                ></p>
              </div>
            </div>
            <!-- Technologies -->
            ...
            >
              ...
              <div class="flex flex-wrap gap-2 sm:gap-3">
                <div
                    ...
                    :key="tech"
                    class="group flex items-center gap-2 px-3 sm:px-4 py-2 rounded-lg transition-colors duration-300"
                    :class="isDarkBackground ? 'bg-black/60 hover:bg-black/70' : 'bg-white/60 hover:bg-white/70'"
                >
                  <component
                      :is="skillsIcons&&skillsIcons[key%4]"
                      class="w-4 h-4 sm:w-5 sm:h-5 transition-colors"
                      :class="isDarkBackground ? 'text-gray-400 group-hover:text-white' : 'text-gray-600 group-hover:text-gray-800'"
                  />
                  <span
            ...
            >
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6">
                <div
                    ...
                    class="group relative rounded-lg overflow-hidden cursor-pointer h-[200px] sm:h-[220px] md:h-[240px] transition-colors duration-300"
                    ...
                    <div class="space-y-2">
                      ...
                      <div class="flex flex-wrap gap-1.5 mt-2">
                        <span
                            ...
                            :class="isDarkBackground ? 'bg-black/60 text-gray-300' : 'bg-white/60 text-gray-700'"
                        >
                          {{ tech }}
                        </span>
                      </div>
          ...
          <div class="space-y-6 sm:space-y-8">
              ...
              <div class="space-y-3 sm:space-y-4">
                <div>
                  <span
                      ...
                      :class="isDarkBackground ? 'text-gray-400' : 'text-gray-500'"
                  >Location</span>
                  <p
                      class="text-sm sm:text-base"
                      :class="isDarkBackground ? 'text-white' : 'text-gray-800'"
            ...
            >
              ...
              <div
                  ...
                  :class="isDarkBackground ? 'text-gray-200' : 'text-gray-700'"
                  v-html="formattedContent(experience.achievements)"
              >
              </div>
            </div>
          </div>
