      ...
      <div class="flex flex-col md:flex-row items-center gap-8">
        ...
        <div class="text-center md:text-left">
          ...
          <div class="flex flex-wrap gap-4 justify-center md:justify-start">
            <button class="px-6 py-2 bg-teal-400 text-white rounded-md hover:bg-teal-500 transition-colors" @click="toRoute('/about/experience')">
              View Experiences
            </button>
            <button class="px-6 py-2 bg-pink-400 text-white rounded-md hover:bg-pink-500 transition-colors" @click="toRoute('/about/project')">
              View Projects
            </button>
            <button class="px-6 py-2 border bg-red-400 text-white rounded-md hover:bg-red-500 transition-colors"  @click="toRoute('/about/profile/manage')">
              Manage
            </button>
          </div>
        </div>
