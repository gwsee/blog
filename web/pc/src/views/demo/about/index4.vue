<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white">
    ...
    <section class="relative py-12">
      <div
          ref="scrollContainer"
          class="project-scroll-container"
          @mousedown="startDrag"
          @mousemove="onDrag"
          @mouseup="stopDrag"
          @mouseleave="stopDrag"
      ...
      >
        <div
            ref="projectsWrapper"
            class="flex gap-6 px-4 md:px-[10vw] transition-transform duration-300"
...
const maxScroll = computed(() => {
  if (!projectsWrapper.value || !scrollContainer.value) return 0
  const containerWidth = scrollContainer.value.clientWidth
  const contentWidth = projectsWrapper.value.scrollWidth
