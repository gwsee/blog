          ...
          <div class="relative z-10">
            ...
            <div class="flex items-center justify-between mb-8">
              <div :class="index % 2 === 1 ? 'order-2' : ''">
                <h2 class="text-4xl font-bold">{{ experience.company }}</h2>
                <h3 class="text-2xl text-gray-400 mt-2">{{ experience.role }}</h3>
              </div>
            ...
            <!-- Main content -->
            <div
                class="grid md:grid-cols-2 gap-8 items-end"
                :class="index % 2 === 1 ? 'md:text-right' : ''"
            >
              <!-- Left column -->
              <div :class="index % 2 === 1 ? 'md:order-2' : ''">
                <p class="text-gray-400 leading-relaxed mb-8">{{ experience.description }}</p>

                <!-- Project Cards Grid -->
                <div class="grid grid-cols-2 gap-4">
                  <!-- First 3 Project Cards -->
                  <template v-for="(project, idx) in experience.projects.slice(0, 3)" :key="project.id">
                    <div
                        class="group relative bg-gray-800 rounded-lg overflow-hidden cursor-pointer"
                        :class="idx === 2 ? 'col-span-2 md:col-span-1' : ''"
                    >
                  ...
                  <div
                      ...
                      :class="experience.projects.length <= 3 ? 'hidden' : ''"
                  >
                    <div class="aspect-square flex items-center justify-center">
                      <div class="text-center">
                        <div class="mb-2">
<!--                          <PlusCircleIcon class="w-8 h-8 mx-auto text-gray-400 group-hover:text-white transition-colors" />-->
                        </div>
                        <span class="text-sm font-medium text-gray-400 group-hover:text-white transition-colors">
                          View {{ experience.projects.length - 3 }} More
                        </span>
                      </div>
                    </div>
                  </div>
              ...
              <div
                  class="relative aspect-square rounded-lg overflow-hidden h-full"
