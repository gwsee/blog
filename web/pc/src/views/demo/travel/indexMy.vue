          ...
          <div :class="gridContainerClasses">
            ...
            <template v-else>
              ...
              >
                <!-- travel Card -->
                <div
                    class="travel-card group relative overflow-hidden rounded-lg h-full"
                ...
                >
                  ...
                  <div class="relative w-full pb-[75%]">
                    ...
                    <div class="absolute bottom-0 left-0 right-0 p-4">
                      <h3 class="text-lg font-medium text-white truncate overflow-hidden whitespace-nowrap">{{ travel.title }}</h3>
                    </div>
                  ...
                  <div class="p-4 flex items-center justify-between">
                    <div class="flex items-center gap-2">
                      ...
                      <span class="text-sm" :class="{'text-white': key/2===0}">
                        {{ travel.account.nickname }}
                      </span>
                      <a-tag
                          v-if="state.user&&state.user.id === travel.account.id"
                          class="border-0 text-xs"
                          :class="key/2===0 ? 'bg-white text-black' : 'bg-black text-white'"
                      >
                        ME
                      </a-tag>
                    </div>
                    <div class="flex items-center gap-3">
                      <span class="flex items-center gap-1" :class="{'text-white': key/2===0}">
                        <HeartOutlined />
...
import {travelList,travelDel} from "@/api/travel";
