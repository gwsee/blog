<template>
  <div class="min-h-screen bg-gray-50/50">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <!-- 图片轮播 -->
      <div class="relative mb-8 rounded-2xl overflow-hidden shadow-lg bg-white">
        <a-carousel class="aspect-video max-h-[70vh] rounded-2xl overflow-hidden" :autoplay="false" ref="carouselRef">
