      ...
      <div ref="scrollContainer" class="relative">
        ...
        >
          <div
              ...
              :key="project.id"
              class="relative flex-shrink-0 w-[280px] h-[400px] rounded-lg overflow-hidden group cursor-pointer"
          >
            <!-- Background Image -->
            <img
                :src="project.image"
            ...
            <div class="relative h-full p-6 flex flex-col justify-between text-white">
              ...
              <div class="space-y-1">
                <div class="flex justify-between items-start">
                  ...
                  <span class="text-sm opacity-75">{{ project.date }}</span>
                </div>
              </div>
              ...
              <div class="space-y-2">
                ...
                <h4 class="text-lg">{{ project.role }}</h4>
        ...
        <button
            ...
            @click="scroll('left')"
            class="absolute -left-5 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center
        ...
        <button
            ...
            @click="scroll('right')"
            class="absolute -right-5 top-1/2 -translate-y-1/2 w-10 h-10 flex items-center justify-center
                 bg-black/30 backdrop-blur-sm rounded-full hover:bg-black/50 transition-colors z-10"
        >
