...
var file_helloworld_v1_greeter_proto_goTypes = []interface{}{
	(*HelloRequest)(nil), // 0: blog.v1.HelloRequest
	(*HelloReply)(nil),   // 1: blog.v1.HelloReply
}
var file_helloworld_v1_greeter_proto_depIdxs = []int32{
	0, // 0: blog.v1.Greeter.SayHello:input_type -> blog.v1.HelloRequest
	1, // 1: blog.v1.Greeter.SayHello:output_type -> blog.v1.HelloReply
