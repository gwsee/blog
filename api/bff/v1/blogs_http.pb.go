...
const OperationBlogsCollect = "/api.bff.v1.Blogs/Collect"
...
const OperationBlogsHotBlogs = "/api.bff.v1.Blogs/HotBlogs"
const OperationBlogsListBlogTags = "/api.bff.v1.Blogs/ListBlogTags"
const OperationBlogsListBlogs = "/api.bff.v1.Blogs/ListBlogs"
const OperationBlogsThumb = "/api.bff.v1.Blogs/Thumb"
...
func RegisterBlogsHTTPServer(s *http.Server, srv BlogsHTTPServer) {
	...
	r.POST("/v1/blogs/hot", _Blogs_HotBlogs0_HTTP_Handler(srv))
	r.POST("/v1/blogs/tags", _Blogs_ListBlogTags0_HTTP_Handler(srv))
	r.POST("/v1/blog/thumb", _Blogs_Thumb0_HTTP_Handler(srv))
	r.POST("/v1/blog/collect", _Blogs_Collect0_HTTP_Handler(srv))
}
...
func _Blogs_ListBlogTags0_HTTP_Handler(srv BlogsHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.ListBlogTags(ctx, req.(*v1.ListBlogsRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*v1.ListBlogTagsReply)
		return ctx.Result(200, reply)
	}
}
...
type BlogsHTTPClient interface {
	...
	HotBlogs(ctx context.Context, req *global.PageInfo, opts ...http.CallOption) (rsp *v1.ListBlogsReply, err error)
	ListBlogTags(ctx context.Context, req *v1.ListBlogsRequest, opts ...http.CallOption) (rsp *v1.ListBlogTagsReply, err error)
...
func (c *BlogsHTTPClientImpl) HotBlogs(ctx context.Context, in *global.PageInfo, opts ...http.CallOption) (*v1.ListBlogsReply, error) {
	var out v1.ListBlogsReply
	pattern := "/v1/blogs/hot"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *BlogsHTTPClientImpl) ListBlogTags(ctx context.Context, in *v1.ListBlogsRequest, opts ...http.CallOption) (*v1.ListBlogTagsReply, error) {
	var out v1.ListBlogTagsReply
	pattern := "/v1/blogs/tags"
	path := binding.EncodeURL(pattern, in, false)
