...
type AccountHTTPClient interface {
	...
	Info(ctx context.Context, req *global.Empty, opts ...http.CallOption) (rsp *global.Response, err error)
	...
	UpdateAccount(ctx context.Context, req *v1.UpdateAccountRequest, opts ...http.CallOption) (rsp *global.Response, err error)
}
...
func (c *AccountHTTPClientImpl) Info(ctx context.Context, in *global.Empty, opts ...http.CallOption) (*global.Response, error) {
	var out global.Response
	pattern := "/v1/info"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *AccountHTTPClientImpl) UpdateAccount(ctx context.Context, in *v1.UpdateAccountRequest, opts ...http.CallOption) (*global.Response, error) {
	var out global.Response
