...
type AccountClient interface {
	CreateAccount(ctx context.Context, in *v1.CreateAccountRequest, opts ...grpc.CallOption) (*global.Empty, error)
	ResetPassword(ctx context.Context, in *v1.ResetPasswordRequest, opts ...grpc.CallOption) (*global.Empty, error)
	LoginByAccount(ctx context.Context, in *v1.LoginByAccountRequest, opts ...grpc.CallOption) (*v1.LoginByAccountReply, error)
	Info(ctx context.Context, in *global.Empty, opts ...grpc.CallOption) (*v1.AccountInfoReply, error)
	UpdateAccount(ctx context.Context, in *v1.UpdateAccountRequest, opts ...grpc.CallOption) (*global.Empty, error)
}
...
func (c *accountClient) CreateAccount(ctx context.Context, in *v1.CreateAccountRequest, opts ...grpc.CallOption) (*global.Empty, error) {
...
func (c *accountClient) ResetPassword(ctx context.Context, in *v1.ResetPasswordRequest, opts ...grpc.CallOption) (*global.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(global.Empty)
...
func (c *accountClient) LoginByAccount(ctx context.Context, in *v1.LoginByAccountRequest, opts ...grpc.CallOption) (*v1.LoginByAccountReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.LoginByAccountReply)
...
func (c *accountClient) Info(ctx context.Context, in *global.Empty, opts ...grpc.CallOption) (*v1.AccountInfoReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.AccountInfoReply)
...
func (c *accountClient) UpdateAccount(ctx context.Context, in *v1.UpdateAccountRequest, opts ...grpc.CallOption) (*global.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(global.Empty)
...
func (UnimplementedAccountServer) CreateAccount(context.Context, *v1.CreateAccountRequest) (*global.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateAccount not implemented")
}
func (UnimplementedAccountServer) ResetPassword(context.Context, *v1.ResetPasswordRequest) (*global.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ResetPassword not implemented")
}
func (UnimplementedAccountServer) LoginByAccount(context.Context, *v1.LoginByAccountRequest) (*v1.LoginByAccountReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LoginByAccount not implemented")
}
func (UnimplementedAccountServer) Info(context.Context, *global.Empty) (*v1.AccountInfoReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Info not implemented")
}
func (UnimplementedAccountServer) UpdateAccount(context.Context, *v1.UpdateAccountRequest) (*global.Empty, error) {
