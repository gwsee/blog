...
const OperationUserMessages = "/api.bff.v1.User/Messages"
...
func RegisterUserHTTPServer(s *http.Server, srv UserHTTPServer) {
	...
	r.POST("/v1/messages", _User_Messages0_HTTP_Handler(srv))
}
...
type UserHTTPClient interface {
	...
	Messages(ctx context.Context, req *global.PageInfo, opts ...http.CallOption) (rsp *v1.MessagesReply, err error)
...
func (c *UserHTTPClientImpl) Messages(ctx context.Context, in *global.PageInfo, opts ...http.CallOption) (*v1.MessagesReply, error) {
	var out v1.MessagesReply
	pattern := "/v1/messages"
	path := binding.EncodeURL(pattern, in, false)
