...
const (
	...
	Tools_UploadOssToken_FullMethodName     = "/api.bff.v1.Tools/UploadOssToken"
	Tools_UploadOssSave_FullMethodName      = "/api.bff.v1.Tools/UploadOssSave"
)
...
type ToolsClient interface {
	...
	// 下面两个是通过客户端上传文件并且保存
	UploadOssToken(ctx context.Context, in *global.IDStr, opts ...grpc.CallOption) (*v1.UploadOssTokenReply, error)
	UploadOssSave(ctx context.Context, in *v1.UploadOssSaveReq, opts ...grpc.CallOption) (*global.Empty, error)
}
...
func (c *toolsClient) UploadOssToken(ctx context.Context, in *global.IDStr, opts ...grpc.CallOption) (*v1.UploadOssTokenReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(v1.UploadOssTokenReply)
	err := c.cc.Invoke(ctx, Tools_UploadOssToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *toolsClient) UploadOssSave(ctx context.Context, in *v1.UploadOssSaveReq, opts ...grpc.CallOption) (*global.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(global.Empty)
	err := c.cc.Invoke(ctx, Tools_UploadOssSave_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedToolsServer) UploadOssToken(context.Context, *global.IDStr) (*v1.UploadOssTokenReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UploadOssToken not implemented")
}
func (UnimplementedToolsServer) UploadOssSave(context.Context, *v1.UploadOssSaveReq) (*global.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UploadOssSave not implemented")
}
...
func _Tools_Files_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(global.IDStr)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ToolsServer).Files(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Tools_Files_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ToolsServer).Files(ctx, req.(*global.IDStr))
	}
	return interceptor(ctx, in, info, handler)
}

func _Tools_UploadOssToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(global.IDStr)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ToolsServer).UploadOssToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Tools_UploadOssToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ToolsServer).UploadOssToken(ctx, req.(*global.IDStr))
	}
	return interceptor(ctx, in, info, handler)
}

func _Tools_UploadOssSave_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v1.UploadOssSaveReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ToolsServer).UploadOssSave(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Tools_UploadOssSave_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ToolsServer).UploadOssSave(ctx, req.(*v1.UploadOssSaveReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Tools_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Files",
			Handler:    _Tools_Files_Handler,
		},
		{
			MethodName: "UploadOssToken",
			Handler:    _Tools_UploadOssToken_Handler,
		},
		{
			MethodName: "UploadOssSave",
			Handler:    _Tools_UploadOssSave_Handler,
		},
	},
