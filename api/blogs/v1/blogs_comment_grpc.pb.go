...
type BlogsCommentClient interface {
	CreateBlogsComment(ctx context.Context, in *CreateBlogsCommentRequest, opts ...grpc.CallOption) (*global.Empty, error)
	UpdateBlogsComment(ctx context.Context, in *UpdateBlogsCommentRequest, opts ...grpc.CallOption) (*global.Empty, error)
	DeleteBlogsComment(ctx context.Context, in *global.ID, opts ...grpc.CallOption) (*global.Empty, error)
	GetBlogsComment(ctx context.Context, in *global.ID, opts ...grpc.CallOption) (*GetBlogsCommentReply, error)
...
func (c *blogsCommentClient) CreateBlogsComment(ctx context.Context, in *CreateBlogsCommentRequest, opts ...grpc.CallOption) (*global.Empty, error) {
...
func (c *blogsCommentClient) UpdateBlogsComment(ctx context.Context, in *UpdateBlogsCommentRequest, opts ...grpc.CallOption) (*global.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(global.Empty)
...
func (c *blogsCommentClient) GetBlogsComment(ctx context.Context, in *global.ID, opts ...grpc.CallOption) (*GetBlogsCommentReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedBlogsCommentServer) CreateBlogsComment(context.Context, *CreateBlogsCommentRequest) (*global.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateBlogsComment not implemented")
}
func (UnimplementedBlogsCommentServer) UpdateBlogsComment(context.Context, *UpdateBlogsCommentRequest) (*global.Empty, error) {
...
func (UnimplementedBlogsCommentServer) GetBlogsComment(context.Context, *global.ID) (*GetBlogsCommentReply, error) {
