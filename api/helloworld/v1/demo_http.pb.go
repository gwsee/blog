...
const OperationDemoDeleteDemo = "/api.helloworld.v1.Demo/DeleteDemo"
const OperationDemoGetDemo = "/api.helloworld.v1.Demo/GetDemo"
const OperationDemoListDemo = "/api.helloworld.v1.Demo/ListDemo"
const OperationDemoUpdateDemo = "/api.helloworld.v1.Demo/UpdateDemo"
...
func RegisterDemoHTTPServer(s *http.Server, srv DemoHTTPServer) {
	r := s.Route("/")
	r.POST("/api.helloworld.v1.Demo/CreateDemo", _Demo_CreateDemo0_HTTP_Handler(srv))
	r.POST("/api.helloworld.v1.Demo/UpdateDemo", _Demo_UpdateDemo0_HTTP_Handler(srv))
	r.POST("/api.helloworld.v1.Demo/DeleteDemo", _Demo_DeleteDemo0_HTTP_Handler(srv))
	r.POST("/api.helloworld.v1.Demo/GetDemo", _Demo_GetDemo0_HTTP_Handler(srv))
	r.POST("/api.helloworld.v1.Demo/ListDemo", _Demo_ListDemo0_HTTP_Handler(srv))
}
...
func (c *DemoHTTPClientImpl) CreateDemo(ctx context.Context, in *CreateDemoRequest, opts ...http.CallOption) (*CreateDemoReply, error) {
	...
	pattern := "/api.helloworld.v1.Demo/CreateDemo"
...
func (c *DemoHTTPClientImpl) DeleteDemo(ctx context.Context, in *DeleteDemoRequest, opts ...http.CallOption) (*DeleteDemoReply, error) {
	...
	pattern := "/api.helloworld.v1.Demo/DeleteDemo"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *DemoHTTPClientImpl) GetDemo(ctx context.Context, in *GetDemoRequest, opts ...http.CallOption) (*GetDemoReply, error) {
	...
	pattern := "/api.helloworld.v1.Demo/GetDemo"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *DemoHTTPClientImpl) ListDemo(ctx context.Context, in *ListDemoRequest, opts ...http.CallOption) (*ListDemoReply, error) {
	...
	pattern := "/api.helloworld.v1.Demo/ListDemo"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *DemoHTTPClientImpl) UpdateDemo(ctx context.Context, in *UpdateDemoRequest, opts ...http.CallOption) (*UpdateDemoReply, error) {
	...
	pattern := "/api.helloworld.v1.Demo/UpdateDemo"
	path := binding.EncodeURL(pattern, in, true)
