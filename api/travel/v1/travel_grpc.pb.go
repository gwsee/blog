...
type TravelClient interface {
	...
	Thumb(ctx context.Context, in *global.ID, opts ...grpc.CallOption) (*GetTravelReply, error)
	Collect(ctx context.Context, in *global.ID, opts ...grpc.CallOption) (*GetTravelReply, error)
}
...
func (c *travelClient) Thumb(ctx context.Context, in *global.ID, opts ...grpc.CallOption) (*GetTravelReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTravelReply)
...
func (c *travelClient) Collect(ctx context.Context, in *global.ID, opts ...grpc.CallOption) (*GetTravelReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTravelReply)
...
func (UnimplementedTravelServer) Thumb(context.Context, *global.ID) (*GetTravelReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Thumb not implemented")
}
func (UnimplementedTravelServer) Collect(context.Context, *global.ID) (*GetTravelReply, error) {
