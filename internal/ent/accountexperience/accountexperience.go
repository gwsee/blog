...
const (
	// Label holds the string label denoting the accountexperience type in the database.
	Label = "account_experience"
	...
	FieldSkills = "skills"
	// Table holds the table name of the accountexperience in the database.
	Table = "account_experience"
)

// Columns holds all SQL columns for accountexperience fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldCreatedBy,
...
// OrderOption defines the ordering options for the AccountExperience queries.
