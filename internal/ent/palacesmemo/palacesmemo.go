...
const (
	// Label holds the string label denoting the palacesmemo type in the database.
	Label = "palaces_memo"
	...
	FieldStatus = "status"
	// Table holds the table name of the palacesmemo in the database.
	Table = "palaces_memo"
)

// Columns holds all SQL columns for palacesmemo fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldCreatedBy,
...
// OrderOption defines the ordering options for the PalacesMemo queries.
